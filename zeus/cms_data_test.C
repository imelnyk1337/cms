...
void cms_data() {
    ...
    Int_t Electron_charge_after_Zto2e[nElec], Electron_cutBased_after_Zto2e[nElec], Electron_simId_after_Zto2e[nElec], Electron_tightCharge_after_Zto2e[nElec],
        Electron_vtxIdx_after_Zto2e[nElec], Electron_genPartIdx_after_Zto2e[nElec];
	UChar_t Electron_lostHits_after_Zto2e[nElec];
	Bool_t Electron_convVeto_after_Zto2e[nElec], Electron_convVetoOld_after_Zto2e[nElec], Electron_isEB_after_Zto2e[nElec],
        Electron_isEE_after_Zto2e[nElec], Electron_isNano_after_Zto2e[nElec], Electron_isPFcand_after_Zto2e[nElec];

    Float_t Electron_SCeta_after_Zto2e[nElec], Electron_convDcot_after_Zto2e[nElec], Electron_convDist_after_Zto2e[nElec],
        Electron_deltaEtaSC_after_Zto2e[nElec], Electron_deltaEtaSCtr_after_Zto2e[nElec],
        Electron_deltaPhiSC_after_Zto2e[nElec], Electron_deltaPhiSCtr_after_Zto2e[nElec], Electron_dr03EcalRecHitSumEt_after_Zto2e[nElec],
        Electron_dr03EcalRecHitSumEtOld_after_Zto2e[nElec], Electron_dr03HcalDepth1TowerSumEt_after_Zto2e[nElec], Electron_dr03HcalDepth1TowerSumEtOld_after_Zto2e[nElec],
        Electron_dr03HcalTowerSumEt_after_Zto2e[nElec], Electron_dr03TkSumPt_after_Zto2e[nElec], Electron_dr03TkSumPtOld_after_Zto2e[nElec], Electron_dxy_after_Zto2e[nElec],
        Electron_dxyErr_after_Zto2e[nElec], Electron_dz_after_Zto2e[nElec], Electron_dzErr_after_Zto2e[nElec], Electron_eInvMinusPInv_after_Zto2e[nElec],
        Electron_eInvMinusPInvOld_after_Zto2e[nElec], Electron_eta_after_Zto2e[nElec], Electron_hoe_after_Zto2e[nElec],
        Electron_ip3d_after_Zto2e[nElec], Electron_mass_after_Zto2e[nElec], Electron_pfRelIso03_all_after_Zto2e[nElec], Electron_pfRelIso03_chg_after_Zto2e[nElec],
        Electron_phi_after_Zto2e[nElec], Electron_pt_after_Zto2e[nElec], Electron_sieie_after_Zto2e[nElec],
        Electron_sieieR1_after_Zto2e[nElec], Electron_sip3d_after_Zto2e[nElec], Electron_x_after_Zto2e[nElec], Electron_y_after_Zto2e[nElec], Electron_z_after_Zto2e[nElec];

    Float_t PV_x_after_Zto2e, PV_y_after_Zto2e, PV_z_after_Zto2e, PV_chi2_after_Zto2e;
    ...
    TH1F* h_Electron_SCeta_after_Zto2e = new TH1F("Electron_SCeta", "", 64u, -3.2, 3.2);
    TH1F* h_Electron_charge_after_Zto2e = new TH1F("Electron_charge", "", 64u, -2, 2);
    TH1F* h_Electron_convDcot_after_Zto2e = new TH1F("Electron_convDcot", "", 64u, -75., 75.);
    TH1F* h_Electron_convDist_after_Zto2e = new TH1F("Electron_convDist", "", 64u, -100., 50.);
    TH1F* h_Electron_convVeto_after_Zto2e = new TH1F("Electron_convVeto", "", 64u, 0., 2.);
    TH1F* h_Electron_convVetoOld_after_Zto2e = new TH1F("Electron_convVetoOld", "", 64u, 0., 2.);
    TH1F* h_Electron_cutBased_after_Zto2e = new TH1F("Electron_cutBased", "", 64u, 0., 5.);
    TH1F* h_Electron_deltaEtaSC_after_Zto2e = new TH1F("Electron_deltaEtaSC", "", 64u, -0.15, 0.15);
    TH1F* h_Electron_deltaEtaSCtr_after_Zto2e = new TH1F("Electron_deltaEtaSCtr", "", 64u, -0.15, 0.15);
    TH1F* h_Electron_deltaPhiSC_after_Zto2e = new TH1F("Electron_deltaPhiSC", "", 64u, -0.5, 0.5);
    TH1F* h_Electron_deltaPhiSCtr_after_Zto2e = new TH1F("Electron_deltaPhiSCtr", "", 64u, -0.5, 0.5);
    TH1F* h_Electron_dr03EcalRecHitSumEt_after_Zto2e = new TH1F("Electron_dr03EcalRecHitSumEt", "", 64u, 0., 25.);
    TH1F* h_Electron_dr03EcalRecHitSumEtOld_after_Zto2e = new TH1F("Electron_dr03EcalRecHitSumEtOld", "", 64u, 0., 70.);
    TH1F* h_Electron_dr03HcalDepth1TowerSumEt_after_Zto2e = new TH1F("Electron_dr03HcalDepth1TowerSumEt", "", 64u, 0., 13.);
    TH1F* h_Electron_dr03HcalDepth1TowerSumEtOld_after_Zto2e = new TH1F("Electron_dr03HcalDepth1TowerSumEtOld", "", 64u, 0., 20.);
    TH1F* h_Electron_dr03HcalTowerSumEt_after_Zto2e = new TH1F("Electron_dr03HcalTowerSumEt", "", 64u, 0., 25.);
    TH1F* h_Electron_dr03TkSumPt_after_Zto2e = new TH1F("Electron_dr03TkSumPt", "", 64u, 0., 25.);
    TH1F* h_Electron_dr03TkSumPtOld_after_Zto2e = new TH1F("Electron_dr03TkSumPtOld", "", 64u, 0., 400.);
    TH1F* h_Electron_dxy_after_Zto2e = new TH1F("Electron_dxy", "", 64u, -3., 3.);
    TH1F* h_Electron_dxyErr_after_Zto2e = new TH1F("Electron_dxyErr", "", 64u, 0., 1.5);
    TH1F* h_Electron_dz_after_Zto2e = new TH1F("Electron_dz", "", 64u, -25., 25.);
    TH1F* h_Electron_dzErr_after_Zto2e = new TH1F("Electron_dzErr", "", 64u, 0., 5.);
    TH1F* h_Electron_eInvMinusPInv_after_Zto2e = new TH1F("Electron_eInvMinusPInv", "", 64u, -0.6, 0.6);
    TH1F* h_Electron_eInvMinusPInvOld_after_Zto2e = new TH1F("Electron_eInvMinusPInvOld", "", 64u, -25., 25.);
    TH1F* h_Electron_eta_after_Zto2e = new TH1F("Electron_eta", "", 64u, -3.2, 3.2);
    TH1F* h_Electron_genPartIdx_after_Zto2e = new TH1F("Electron_genPartIdx", "", 64u, -2., 2.);
    TH1F* h_Electron_hoe_after_Zto2e = new TH1F("Electron_hoe", "", 64u, 0., 5.);
    TH1F* h_Electron_ip3d_after_Zto2e = new TH1F("Electron_ip3d", "", 64u, -150., 150.);
    TH1F* h_Electron_isEB_after_Zto2e = new TH1F("Electron_isEB", "", 64u, 0., 2.);
    TH1F* h_Electron_isEE_after_Zto2e = new TH1F("Electron_isEE", "", 64u, 0., 2.);
    TH1F* h_Electron_isNano_after_Zto2e = new TH1F("Electron_isNano", "", 64u, 0., 2.);
    TH1F* h_Electron_isPFcand_after_Zto2e = new TH1F("Electron_isPFcand", "", 64u, 0., 2.);
    TH1F* h_Electron_lostHits_after_Zto2e = new TH1F("Electron_lostHits", "", 64u, 0., 10.);
    TH1F* h_Electron_mass_after_Zto2e = new TH1F("Electron_mass", "", 64u, -0.2, 0.2);
    TH1F* h_Electron_nNano_after_Zto2e = new TH1F("Electron_nNano", "", 64u, 0., 7.);
    TH1F* h_Electron_pfRelIso03_all_after_Zto2e = new TH1F("Electron_pfRelIso03_all", "", 64u, 0., 40.);
    TH1F* h_Electron_pfRelIso03_chg_after_Zto2e = new TH1F("Electron_pfRelIso03_chg", "", 64u, 0, 40.);
    TH1F* h_Electron_phi_after_Zto2e = new TH1F("Electron_phi", "", 64u, -3.2, 3.2);
    TH1F* h_Electron_pt_after_Zto2e = new TH1F("Electron_pt", "", 64u, 0., 200.);
    TH1F* h_Electron_sieie_after_Zto2e = new TH1F("Electron_sieie", "", 64u, 0., 1.);
    TH1F* h_Electron_sieieR1_after_Zto2e = new TH1F("Electron_sieieR1", "", 64u, 0., 1.);
    TH1F* h_Electron_simId_after_Zto2e = new TH1F("Electron_simId", "", 64u, -1.5, 0.5);
    TH1F* h_Electron_sip3d_after_Zto2e = new TH1F("Electron_sip3d", "", 64u, -50., 2000.);
    TH1F* h_Electron_tightCharge_after_Zto2e = new TH1F("Electron_tightCharge", "", 64u, 0., 3.);
    TH1F* h_Electron_vtxIdx_after_Zto2e = new TH1F("Electron_vtxIdx", "", 64u, 0, 0);
    TH1F* h_Electron_x_after_Zto2e = new TH1F("Electron_x", "", 64u, -5., 5.);
    TH1F* h_Electron_y_after_Zto2e = new TH1F("Electron_y", "", 64u, -5., 5.);
    TH1F* h_Electron_z_after_Zto2e = new TH1F("Electron_z", "", 64u, -30., 30.);
    TH1F* h_PV_x_after_Zto2e = new TH1F("PV_x", "", 64u, -50., 50.);
    TH1F* h_PV_y_after_Zto2e = new TH1F("PV_y", "", 64u, -50., 50.);
    TH1F* h_PV_z_after_Zto2e = new TH1F("PV_z", "", 64u, -50., 50.);
    TH1F* h_PV_chi2_after_Zto2e = new TH1F("PV_chi2", "", 64u, 0., 1000.);
    ...
    h_PV_x_after_Zto2e->Write();
    h_PV_y_after_Zto2e->Write();
    h_PV_z_after_Zto2e->Write();
    h_PV_chi2_after_Zto2e->Write();
